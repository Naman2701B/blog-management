...
// var CLIENT_ID =
//     "639609669934-eaescllh1k9fpp4nggtdoh1lc0p8kihh.apps.googleusercontent.com";
...
//         var twoWords =
//             text.value.split(" ")[0] + "-" + text.value.split(" ")[1];
//         // set file metadata
//         var metadata = {
...
//                 twoWords +
//                 "-" +
//                 String(Math.random() * 10000).split(".")[0] +
//                 ".txt",
//             mimeType: "plain/text",
...
//         expandContainer.style.top =
//             click_position.top + window.scrollY + 25 + "px";
...
//             } else {
//                 listcontainer.innerHTML =
//                     '<div style="text-align: center;">No Files</div>';
//             }
//         });
// }
...
//                     .setAttribute("data-update-id", id);
