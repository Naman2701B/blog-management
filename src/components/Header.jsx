    ...
    <section className="sticky top-0 left-0 right-0 z-50 bg-white">
        <header className="container mx-auto px-5 flex justify-between py-4 items-center">
            ...
            <div className="lg:hidden z-50">
                {navIsVisible ? <AiOutlineClose className = "w-6 h-6" onClick={navVisbilityHandler}/> : <AiOutlineMenu className = "w-6 h-6" onClick={navVisbilityHandler}/>}
            </div>
            <div className={`${navIsVisible ? "right-0" : "-right-full"} transition-all duration-300mt-[56px] lg:mt-0 bg-dark-hard lg:bg-transparent z-[49] flex flex-col w-full lg:w-auto justify-center lg:justify-end lg:flex-row fixed top-0 bottom-0 lg:static gap-x-9 items-center`}>
