    ...
    return(
        <section className = "container mx-auto flex flex-col px-5 py-5 lg:flex-row">
            <div className="mt-10 lg:w-1/2">
                ...
                <div className="flex flex-col gap-y-2.5 mt-10 lg:mt-6 xl:mt-10 relative">
                    <div className="relative">
                        ...
                        placeholder:text-[#959EAD] rounded-lg pl-12 pr-3 w-full py-3 focus:outline-none shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px] md:py-4" type="text" placeholder="Search Article"/>
                    </div>
            ...
            <div className="hidden lg:block lg:1/2">
                <img className="w-full" src={images.HomePageDemo} alt="Users are reading articles" />
            </div>
        </section>
    );
};
